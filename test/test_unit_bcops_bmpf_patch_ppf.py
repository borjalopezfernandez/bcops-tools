...
def test_patch_ppf_redmine_7501(print_separator):
    """
    GIVEN
    WHEN 
    THEN
    ...
    logger.info(f'copy file BIO_OPER_MPL_PPF_1__20260629T000000_20260705T235959_0001.EOF to /data/mpf/BMPF/data/outgoing/MPL_PPF___')
    shutil.copyfile('test/data/BIO_OPER_MPL_PPF_1__20260629T000000_20260705T235959_0001.EOF', '/data/mpf/BMPF/data/outgoing/MPL_PPF___/BIO_OPER_MPL_PPF_1__20260629T000000_20260705T235959_0001.EOF')

    if pathlib.Path('/data/mpf/BMPF/BIO_OPER_MPL_PPF_1__20260629T000000_20260705T235959_0001.EOF_ORIGINAL').exists():
        logger.info('remove file /data/mpf/BMPF/BIO_OPER_MPL_PPF_1__20260629T000000_20260705T235959_0001.EOF_ORIGINAL')
        os.remove('/data/mpf/BMPF/BIO_OPER_MPL_PPF_1__20260629T000000_20260705T235959_0001.EOF_ORIGINAL')

    if pathlib.Path('/data/mpf/BMPF/BIO_OPER_MPL_PPF_1__20260629T000000_20260705T235959_0001.EOF_PATCHED').exists():
        logger.info('remove file /data/mpf/BMPF/BIO_OPER_MPL_PPF_1__20260629T000000_20260705T235959_0001.EOF_PATCHED')
        os.remove('/data/mpf/BMPF/BIO_OPER_MPL_PPF_1__20260629T000000_20260705T235959_0001.EOF_PATCHED')
    
    cmd = f'bcops_bmpf_patch_ppf -f BIO_OPER_MPL_PPF_1__20260629T000000_20260705T235959_0001.EOF'
    logger.info(cmd)
    exit = os.system(cmd)
    assert( exit >> 8 == 0 )
