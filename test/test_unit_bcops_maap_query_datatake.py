...
def test_TOM_GC1_MC2_S1_RAW__0S(print_separator):
    """
    GIVEN test_conversion
    WHEN 
    THEN
    """
    logger.info(f"START : {sys._getframe().f_code.co_name} / {version('bcops')}")
    cmd             = f'bcops_maap_query_datatake --type S1_RAW__0S --start 2026-02-10T00:34:29Z --end 2026-03-03T00:34:43Z -D -C > TOM_GC1_MC2_S1_RAW__0S.datatakes'
    logger.info(cmd)
    exit = os.system(cmd)
    assert(exit == 0)
    logger.info(f"END : {sys._getframe().f_code.co_name} / {version('bcops')}")
...
def test_TOM_GC1_MC2_S1_SCS__1S(print_separator):
    """
    GIVEN test_conversion
    WHEN 
    THEN
    """
    logger.info(f"START : {sys._getframe().f_code.co_name} / {version('bcops')}")
    cmd             = f'bcops_maap_query_datatake --type S1_SCS__1S --start 2026-02-10T00:34:29Z --end 2026-03-03T00:34:43Z -D -C > TOM_GC1_MC2_S1_SCS__1S.datatakes'
    logger.info(cmd)
    exit = os.system(cmd)
    assert(exit == 0)
    logger.info(f"END : {sys._getframe().f_code.co_name} / {version('bcops')}")
...
def test_TOM_GC1_MC2_S1_DGM__1S(print_separator):
    """
    GIVEN test_conversion
    WHEN 
    THEN
    """
    logger.info(f"START : {sys._getframe().f_code.co_name} / {version('bcops')}")
    cmd             = f'bcops_maap_query_datatake --type S1_DGM__1S --start 2026-02-10T00:34:29Z --end 2026-03-03T00:34:43Z -D -C > TOM_GC1_MC2_S1_DGM__1S.datatakes'
    logger.info(cmd)
    exit = os.system(cmd)
    assert(exit == 0)
    logger.info(f"END : {sys._getframe().f_code.co_name} / {version('bcops')}")
...
def test_TOM_GC1_MC2_S1_STA__1S(print_separator):
    """
    GIVEN test_conversion
    WHEN 
    THEN
    """
    logger.info(f"START : {sys._getframe().f_code.co_name} / {version('bcops')}")
    cmd             = f'bcops_maap_query_datatake --type S1_STA__1S --start 2026-02-10T00:34:29Z --end 2026-03-03T00:34:43Z -D -C > TOM_GC1_MC2_S1_STA__1S.datatakes'
    logger.info(cmd)
    exit = os.system(cmd)
    assert(exit == 0)
    logger.info(f"END : {sys._getframe().f_code.co_name} / {version('bcops')}")
...
def test_TOM_GC1_MC2_S2_RAW__0S(print_separator):
    """
    GIVEN test_conversion
    WHEN 
    THEN
    """
    logger.info(f"START : {sys._getframe().f_code.co_name} / {version('bcops')}")
    cmd             = f'bcops_maap_query_datatake --type S2_RAW__0S --start 2026-03-03T00:34:43Z --end 2026-03-24T00:34:57Z -D -C > TOM_GC1_MC2_S2_RAW__0S.datatakes'
    logger.info(cmd)
    exit = os.system(cmd)
    assert(exit == 0)
    logger.info(f"END : {sys._getframe().f_code.co_name} / {version('bcops')}")
...
def test_TOM_GC1_MC2_S2_SCS__1S(print_separator):
    """
    GIVEN test_conversion
    WHEN 
    THEN
    """
    logger.info(f"START : {sys._getframe().f_code.co_name} / {version('bcops')}")
    cmd             = f'bcops_maap_query_datatake --type S2_SCS__1S --start 2026-03-03T00:34:43Z --end 2026-03-24T00:34:57Z -D -C > TOM_GC1_MC2_S2_SCS__1S.datatakes'
    logger.info(cmd)
    exit = os.system(cmd)
    assert(exit == 0)
    logger.info(f"END : {sys._getframe().f_code.co_name} / {version('bcops')}")
...
def test_TOM_GC1_MC2_S2_DGM__1S(print_separator):
    """
    GIVEN test_conversion
    WHEN 
    THEN
    """
    logger.info(f"START : {sys._getframe().f_code.co_name} / {version('bcops')}")
    cmd             = f'bcops_maap_query_datatake --type S2_DGM__1S --start 2026-03-03T00:34:43Z --end 2026-03-24T00:34:57Z -D -C > TOM_GC1_MC2_S2_DGM__1S.datatakes'
    logger.info(cmd)
    exit = os.system(cmd)
    assert(exit == 0)
    logger.info(f"END : {sys._getframe().f_code.co_name} / {version('bcops')}")
...
def test_TOM_GC1_MC2_S2_STA__1S(print_separator):
    """
    GIVEN test_conversion
    WHEN 
    THEN
    """
    logger.info(f"START : {sys._getframe().f_code.co_name} / {version('bcops')}")
    cmd             = f'bcops_maap_query_datatake --type S2_STA__1S --start 2026-03-03T00:34:43Z --end 2026-03-24T00:34:57Z -D -C > TOM_GC1_MC2_S2_STA__1S.datatakes'
    logger.info(cmd)
    exit = os.system(cmd)
    assert(exit == 0)
    logger.info(f"END : {sys._getframe().f_code.co_name} / {version('bcops')}")
...
def test_TOM_GC1_MC2_S3_RAW__0S(print_separator):
    """
    GIVEN test_conversion
    WHEN 
    THEN
    """
    logger.info(f"START : {sys._getframe().f_code.co_name} / {version('bcops')}")
    cmd             = f'bcops_maap_query_datatake --type S3_RAW__0S --start 2026-03-24T00:34:57Z --end 2026-04-14T00:35:10Z -D -C > TOM_GC1_MC2_S3_RAW__0S.datatakes'
    logger.info(cmd)
    exit = os.system(cmd)
    assert(exit == 0)
    logger.info(f"END : {sys._getframe().f_code.co_name} / {version('bcops')}")
...
def test_TOM_GC1_MC2_S3_STA__1S(print_separator):
    """
    GIVEN test_conversion
    WHEN 
    THEN
    """
    logger.info(f"START : {sys._getframe().f_code.co_name} / {version('bcops')}")
    cmd             = f'bcops_maap_query_datatake --type S3_STA__1S --start 2026-03-24T00:34:57Z --end 2026-04-14T00:35:10Z -D -C > TOM_GC1_MC2_S3_STA__1S.datatakes'
    logger.info(cmd)
    exit = os.system(cmd)
    assert(exit == 0)
    logger.info(f"END : {sys._getframe().f_code.co_name} / {version('bcops')}")    
